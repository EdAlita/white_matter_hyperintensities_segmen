...
--ckpt_path /localmount/volume-hd/users/uline/segmentation_results/uk-biobank/$dir/FastSurferUNET/checkpoints/FastSurferUNET_axial/Epoch_00046_training_state.pkl \
--num_channels $num
...
--ckpt_path /localmount/volume-hd/users/uline/segmentation_results/uk-biobank/$dir/FastSurferUNET/checkpoints/FastSurferUNET_coronal/Epoch_00054_training_state.pkl \
--num_channels $num
...
--ckpt_path /localmount/volume-hd/users/uline/segmentation_results/uk-biobank/$dir/FastSurferUNET/checkpoints/FastSurferUNET_sagital/Epoch_00052_training_state.pkl \
--num_channels $num
...
--ckpt_path /localmount/volume-hd/users/uline/segmentation_results/uk-biobank/$dir/FastSurferCNN/checkpoints/FastSurferCNN_axial/Epoch_00052_training_state.pkl \
--num_channels $num
...
--ckpt_path /localmount/volume-hd/users/uline/segmentation_results/uk-biobank/$dir/FastSurferCNN/checkpoints/FastSurferCNN_coronal/Epoch_00054_training_state.pkl \
--num_channels $num
...
--ckpt_path /localmount/volume-hd/users/uline/segmentation_results/uk-biobank/$dir/FastSurferCNN/checkpoints/FastSurferCNN_sagital/Epoch_00052_training_state.pkl \
--num_channels $num
